...
public class JsonFileUtil {
    ...
    public static String findJsonFile(String url){
        String pathProjTest = "./src/test/resources/"+url;
        String clazzPath = "./test-classes/"+url;
        String pathProj = "./src/main/resources/"+url;
        File fileProjTest = new File(pathProjTest);
        File fileClazz = new File(clazzPath);
        File fileProj = new File(pathProj);
        if (fileProjTest.exists()){
            return pathProjTest;
        }else if(fileClazz.exists()){
            return clazzPath;
        }else if (fileProj.exists()){
            return pathProj;
        }
        else {
            return null;
    ...
    public static List<JSONObject> listStringToJson(List<String> list) {
        ...
        List<JSONObject> listobj = new LinkedList<JSONObject>();
        while (it.hasNext()) {
